...
## Evaluation einer lautlosen MRT Sequenz
...
Falls Sie an einer Studienteilnahme interessiert sind und oben die genannten Kriterien auf Sie zutreffen, kontaktieren Sie uns bitte für weitere Informationen unter folgendem <span style="text-decoration:underline">[Link](https://redcap.link/Participate_Neurolinguistics)</span> oder per <span style="text-decoration:underline">[E-Mail](neuroling-lab@linguistik.uzh.ch)</span>
