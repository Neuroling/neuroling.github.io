...
### Simply complete this <span style="text-decoration:underline">[form](https://redcap.link/Participate_Neurolinguistics)</span>, and we will reach out with upcoming opportunities!
...
### [For further details and information, click here](images/Flyer_DE_V3_commit.pdf)
...
## Evaluation einer lautlosen fMRT Sequenz

Last compiled: `r Sys.Date()`

Zur Evaluierung der neuen, fast lautlosen MRT Sequenz “Looping Star” suchen wir Probanden/Probandinnen im Alter 18 – 40 Jahre, die bereit sind, für 30 – 45 Minuten an einem MR Kopfscan am Kinderspital Zürich teilzunehmen. Während der Looping Star und einer standardmässigen MR Sequenz werden die Probanden/Probandinnen sich verschiedene kurze Ausschnitte einer Geschichte anhören. Dies dient dazu, die auditorische Verarbeitung optimal zu erfassen und zwischen den beiden Scan Sequenzen vergleichen zu können und die Aufgabe für eine weitere Studie, im Zuge deren fötale Scans gemacht werden, zu validieren. Die Studie ist mit keinerlei Risiken verbunden und MR Aufnahmen gelten unter Berücksichtigung der nachfolgenden Kriterien als ungefährlich.

Zur Teilnahme an der Studie müssen die Kriterien für MR-Messungen erfüllt sein: Versuchspersonen dürfen keine Metallimplantate oder grossflächige Tattoos im Brust-, Kopf, oder Nackenbereich, und keinen Zahndraht aufweisen. Weitere Informationen erhalten die potentiellen Versuchspersonen nach der Kontaktaufnahme (MR-Sicherheitsfragebogen, Zustimmungsformular etc.). Versuchspersonen müssen weiterhin frei von neurologischen oder psychiatrischen Diagnosen sein, über ein gesundes Hörvermögen verfügen und Deutsch als Muttersprache haben (multilinguale Probanden/Probandinnen werden auch eingeschlossen).

Bei Interesse können sich potentielle Probanden/Probandinnen bei [Dr. Christopher Ritter](mailto:christopher%5Bdot%5Dritter%5Bat%5Dunige%5Bdot%5Dch) melden.

 
Gesamte Dauer: ca. 1 Stunde
Entlöhnung: 50 CHF oder 1.5 Versuchspersonenstunden
